...
class NewsSummaryAgent:
    ...
    def run(self, ticker: str, data: dict) -> dict:
        ...
        for item in sel_news:
            ...
            elif desc: text += f" | Content: {desc}" # Changed from description only to content for consistency
    ...
    for i, t in enumerate(tickers):
        ...
        for agent in agents:
            ...
            try:
                ...
                st.error(f"Error in {name} for {t}: {e}")
        ...
        with st.container(border=True):
            ...
            if chronological_transactions:
                ...
                for tx in chronological_transactions:
                    ...
                    tx_date = tx_date_naive.replace(tzinfo=timezone.utc)
