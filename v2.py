    ...
    for t in tickers:
        ...
        if configs["use_sentiment"]:
            ...
            if yfinance_news and not (isinstance(yfinance_news[0], dict) and "error" in yfinance_news[0]):
                for item in yfinance_news: item['source_api'] = 'Yahoo Finance'
            ...
            if llm_client and st.secrets.get("NEWSAPI_KEY"):
                ...
                if newsapi_articles and not (isinstance(newsapi_articles[0], dict) and "error" in newsapi_articles[0]):
                 ...
                 news_fetch_status_messages.append("NewsAPI Key not configured; only Yahoo Finance news will be used if available.")
        ...
        if not deduplicated_news and not news_fetch_status_messages:
        ...
        data_bundle = {
            ...
            "news_fetch_status_error": news_fetch_status_for_bundle if "Error" in news_fetch_status_for_bundle or "failed" in news_fetch_status_for_bundle.lower() else None,
